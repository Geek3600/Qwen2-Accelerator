...
object DM1Gen extends App {
  ...
  // │  DataMen ←→ LoadU:                                                          │
  // │  ┌──────────────────────────────────────────────────────────────────────┐   │
  // │  │  DataMen.r_ready ──────────────────────→ LoadU.data_in_ready         │   │
  // │  │  LoadU.data_in_addr ───────────────────→ DataMen.raddr               │   │
  // │  │  DataMen.rdata ────────────────────────→ LoadU.data_in               │   │
  // │  └──────────────────────────────────────────────────────────────────────┘   │
  // │                                                                             │
  // │  LoadU ←→ DMCUPlus:                                                         │
  // │  ┌──────────────────────────────────────────────────────────────────────┐   │
  // │  │  LoadU.data_out ───────────────────────→ DMCUPlus.data_in            │   │
  // │  │  LoadU.data_out_valid ─────────────────→ DMCUPlus.data_in_valid      │   │
  // │  │  LoadU.data_out_start ─────────────────→ DMCUPlus.data_in_start      │   │
  // │  │  (无反压信号，LoadU通过空转来等待DMCUPlus)                               │   │
  // │  └──────────────────────────────────────────────────────────────────────┘   │
  // │                                                                             │
  // │  DMCUPlus ←→ StoreU:                                                        │
  // │  ┌──────────────────────────────────────────────────────────────────────┐   │
  // │  │  DMCUPlus.res ─────────────────────────→ StoreU.data_in              │   │
  // │  │  DMCUPlus.res_valid ───────────────────→ StoreU.data_in_valid        │   │
  // │  │  StoreU.data_out_ready ────────────────→ DMCUPlus.res_ready          │   │
  // │  └──────────────────────────────────────────────────────────────────────┘   │
  // │                                                                             │
  // └─────────────────────────────────────────────────────────────────────────────┘