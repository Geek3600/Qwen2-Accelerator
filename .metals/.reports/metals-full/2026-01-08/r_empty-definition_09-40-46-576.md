error id: file://<WORKSPACE>/src/main/scala/SiLU/Top.scala:`<none>`.
file://<WORKSPACE>/src/main/scala/SiLU/Top.scala
...
non-local guesses:
	 ...
	 -scala/Predef.StoreU#
offset: 788
uri: file://<WORKSPACE>/src/main/scala/SiLU/Top.scala
text:
```scala
package SiLU
import Common._
...
class PipLine extends Module {
  ...
  val su_inst = Module(new Sto@@reU)
